...
; Updated 2019 by SparrOSDeveloperTeam
; 
...
; *** has been on by default since 3.3 - moving to inside ansi_f.asm!
...
sm_rs:	mov	is_g_override, 0	; stop overrides
	...
	cmp	al, 99			; for compatibility with ansi
	jnz	sm_notgc
		mov	pseudo_flag, cl
		jmp	short sm_done
sm_notgc:
...
key_init:
	...
	; ansi_i is next, has to start with dosfn0
code	ends
	end                          	; of ansi_f.asm
