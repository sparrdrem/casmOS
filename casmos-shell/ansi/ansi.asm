...
;------------------------------------------------------------------------
	...
	; to both ansi_p.asm and ansi_f.asm
...
; ---	db	27, '[2J', 13, 10
	...
	db	13,10,"This is the ANSI.sys device driver. Read NANSI.DOC."
	db	13,10,26	; EOF
...
; This table can be set from the commandline when loading ANSI (see ansi_i).
...
interrupt	proc	far
	...
	cbw				; THIS WAS LEFT OUT IN CLASIC ANSI!
...
; *** Must return status in AX. ES:BX destroyed. New in ANSI 4.0 ***
chaincmd	proc	near
