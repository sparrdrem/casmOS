...
COMBAD  DB      13,10,"Bad Kernel, Kernel Panic"
NEEDCOM DB      13,10,"Insert casmOS disk in "
        IF      IBMVER
        DB      "drive A"
        ELSE
        DB      "default drive"
...
HEADER  DB      13,10,"$$$"
        ...
        IF IBMVER
HEADER  DB      13,10,13,10,"Intel x86_64 compatible PC running casmOS",13,10
        DB      "Version 0.0.1 (Alpha)",13,10,"$"
        DB      "Unlicensed software"
        ENDIF
